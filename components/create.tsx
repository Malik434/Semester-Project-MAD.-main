...
export const CreateScreen = () => {
  ...
  const copyToClipboard = () => {
    ...
    Alert.alert(
      "Copied",
      "Mnemonic copied to clipboard. Be careful not to share it!"
    );
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.subContainer}>
        <Text style={styles.fontSize}>
          The mnemonic phrase will help you back up your account information in
  ...
  return (
    <View style={[styles.container, styles2.container]}>
      <View style={styles2.title}>
        {errMes ? (
          <Text style={[styles2.titleText, styles2.redColor]}>
            Mnemonic Phrase Incorrect
          </Text>
        ) : (
          <Text style={styles2.titleText}>
            Confirm Your Backed Up Mnemonic Phrase
          </Text>
        )}
      </View>
